...
# Adapted by Nikolaus Demmel 2014
...
if(EXISTS "${PYTHON_INCLUDE_PATH}" AND EXISTS "${PYTHON_LIBRARY}" AND EXISTS "${PYTHON_SITE_PACKAGES_DIR}")
  ...
  FIND_PACKAGE(PythonInterp ${PythonLibs_FIND_VERSION})
  ...
  if(PYTHONINTERP_FOUND)
    ...
    if(python_config)
      ...
      STRING(REGEX REPLACE ".*\npy_lib_dir:([^\n]+).*$" "\\1" PYTHON_LIBRARY_DIR ${python_config})
      ...
      FIND_LIBRARY(PYTHON_LIBRARY NAMES ${PYTHON_LIBRARY_NAMES} PATH_SUFFIXES python${PYTHON_SHORT_VERSION}/config python${PYTHON_SHORT_VERSION_NO_DOT}/config PATHS ${PYTHON_LIBRARY_DIR} ${PYTHON_PREFIX}/lib ${PYTHON_PREFIX}/libs NO_DEFAULT_PATH)
